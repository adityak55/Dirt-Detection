...
test_model, inference_config = load_inference_model(1, r"C:\intern\Mask_RCNN\mask_rcnn_object_0019.h5")
print('Hi')
# Load Image
...
class image:
    def seg(self,img,id_list,id):
        ...
        # message = """From: From Person <Sender's Email ID>
        #                     To: To Person <Receiver's Email ID>
        #                     Subject: Anomaly detected Unlean Tanker x% Location Date Time
        #
        ...
        if (cleanliness < 70):
            ...
            cv2.putText(img, f'{cleanliness}', (100, 100),
                        ...
                        (0, 255, 255), 2)
            cv2.imwrite(r"C:\intern\Mask_RCNN\anomilies\pic" + ' ' + str(
            ...
            # s.sendmail("<Sender's email address>", "Receiver's Email Address", message)
        if(k==1):
